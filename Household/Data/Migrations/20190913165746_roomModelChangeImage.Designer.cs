...
namespace Household.Data.Migrations
{
    ...
    [Migration("20190913165746_roomModelChangeImage")]
    partial class roomModelChangeImage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Household.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Household.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
